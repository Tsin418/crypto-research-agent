...
In Cloudflare Pages, configure this as a Pages build-time environment variable,
not only as a Worker runtime variable. This variable is embedded at build time,
so rebuild and redeploy the frontend after changing it.
